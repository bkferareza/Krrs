...
<div style="font-size:15px; padding-top:40px; margin-left:30px; font-family:Arial, Helvetica, sans-serif;">Your Book has been Registered
</div>
...
<div style="font-size:15px; padding-top:40px; margin-left:20px; margin-right:20px; font-family:Arial, Helvetica, sans-serif; text-align:center">You can borrow the book only 3 items..
</div>
...
<div class="set">
<img align="right" src="icons/help.png" />
</div>
...
if(isset($_GET['studentid'])){
	...
	$id=$_GET['studentid'];
	$sql="SELECT * FROM tblborrower where studentid=$id";
	$rs=mysql_query($sql);
...
<tr><td>Name</td><td>Borrower ID</td>
</tr>
<tr>
<td>
<input type="text" readonly="readonly" value="<?php echo $get['lname'].",&nbsp;".$get['fname']."&nbsp;".$get['mi']; ?>" name="name" style="width:200px; padding:4px;" onclick="clear()" class="search" id="searchbox" />
</td><td>
<input type="text" readonly="readonly" value="<?php echo $get['studentid']; ?>" name="studentid" style="width:100px; padding:4px;" onclick="clear()" class="search" id="searchbox" />
</td>
</tr>
</table>
...
<tr><td colspan="3">Choose Category</td></tr>
<tr>
<td colspan="3">
<select 
...
<?php if(isset($_GET['accNo'])){
	$res=mysql_query("select * from books where accNo=$_GET[accNo]");
...
<tr><td>Default Value&nbsp;&nbsp;
<a href=""><img src="icons/b_help.png" title="Book fee for due date, <?php echo $rowpay['amount']; ?> per day" /></a>
</td>
<td></td>
</tr>
<tr>
...
var top = (screen.height/2)-(h/2);
      var targetWin =  window.open('default.php' + borrowid, 'name', 'location=no,menubar=no,wiscrollbars=no,resizable=no,fullscreen=no,width='+w+', height='+h+', top='+top+', left='+left);
        return false;
    }
