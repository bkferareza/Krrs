...
<div class="menuwrap">
   <div class="menu">
        ...
        <li>
            ...
            <li>
                <a href="#"><span class="img"><img src="icons/b_tran.png" width='20px'  height='18px' style=" padding-top:3px;"></span>&nbsp;Transaction<span class="arrow"></span></a>
            ...
            <li>
                <a href="#"><span class="img"><img src="images/returnbook.png" width='20px'  height='18px' style=" padding-top:3px;"></span>&nbsp;Borrowers<span class="arrow"></span></a>
                <ul>
            ...
            <li>
                <a href="#"><span class="img"><img src="icons/b_select.png" width='20px'  height='18px' style=" padding-top:3px;"></span>&nbsp;View<span class="arrow"></span></a>
                <ul>
