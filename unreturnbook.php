...
<SCRIPT language="javascript">
   ...
   <script>
       ...
       window.location='library.php?unreturnedBooks';
        }
    </script>
...
var top = (screen.height/2)-(h/2);
      var targetWin =  window.open('unreturn_check.php?borrowid=' + borrowid, 'name', 'location=no,menubar=no,wiscrollbars=no,resizable=no,fullscreen=no,width='+w+', height='+h+', top='+top+', left='+left);
        return false;
    }*/
