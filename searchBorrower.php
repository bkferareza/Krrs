...
jQuery(function($){
   $("#searchbox").Watermark("Search Borrowers Name,Last Name");
   });
...
<tr  bgcolor="#B9C9FE" height="30">
   <td class="web" width="230">First Name</td>
    <td class="web" width="250">Last Name</td>
    <td class="web" width="250">Middle I.</td>
    <td class="web" width="190" colspan="3">Edit</td>
  </tr>
  </table>
</div>
<div class="scroll">
