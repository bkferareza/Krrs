...
if(isset($_GET['studentid'])){
 ...
 ?>
<table id="table" width="150" height="150" border="0" style=" border:1px inset #999; float:right; margin-right:50px; margin-top:75px;">
<tr>
<td>
<?php 
if($name['photo']==false){ ?>
<img src="icons/noavatar92.png" width="150" height="150" />
<?php }else{?>
<img src="borrowersphoto/<?php echo $name['photo']; ?>" width="150" height="150"/>
<?php } ?>
</td>
</tr>
</table>
<table width="100%" border="0" align="center" style="margin-top:30px; float:right; margin-right:50px; " >
  <tr>
    <td align="center" style="font-size:20px;  font-weight:bold;font-family:Arial, 'Arial Black', 'Arial Narrow';">Imus Institute of Science and Technology</td>
   
  </tr>
  <tr>
    <td style="font-size:17px; font-weight:bold; font-family:Arial, 'Arial Black', 'Arial Narrow';" align="center">82 Nueno Ave, Imus, 4103 Cavite, Philippines</td>   
  </tr>
  <tr>
...
<script>
jQuery(function($){
   $("#searchbox").Watermark(<?php if(isset($_GET['studentid'])){?> 
   "<?php echo $name['fname'];?> <?php echo $name['mi']; ?> <?php echo $name['lname']; ?>"
	<?php }else{ ?>
