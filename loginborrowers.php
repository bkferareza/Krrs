...
<table width="" border="0" style=" margin-left:40px; margin-top:30px;font-size:13px;font-family:Verdana, Geneva, sans-serif; ">
  <tr>
    <td>Acc. No.</td>
    <td><input type="text" readonly="readonly" style="padding:5px; border:1px black solid;" value="<?php echo $_GET['accNo']; ?>" class="ts" /></td>
  </tr>
   <tr>
    <td>Book Title</td>
...
if($row){
	...
	echo "<script>window.location='?accNo=$_GET[accNo]&create&pass&studentid=$row[studentid]'</script>";
